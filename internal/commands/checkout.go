...
var checkoutCmd = &cobra.Command{
	...
	Long:    `Checkout to a branch. If no branch is supplied, list available branches with trunk branch at the bottom and oldest branches first, progressing to most recently edited. You can navigate using up/down arrows to select from the list, and type to filter branches.`,
